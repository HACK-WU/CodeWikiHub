...
**强依赖业务专家**：检索与向量客户端专家（vector-client）、关系与索引管理专家（sync-relation/query-group/get-module-info/manage-index/delete-relation）、知识索引导入专家（ki import 导入链路，经 `/api/import/*`）。
