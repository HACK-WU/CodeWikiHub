...
- [web/src/components/ModuleDrawer.tsx](file://web/src/components/ModuleDrawer.tsx)
- [web/src/styles/ki.css](file://web/src/styles/ki.css)
</cite>

## 更新摘要
**所做更改**
- 更新了搜索页面的阈值控制功能，改进了滑块接口的用户体验
- 在浏览页面添加了刷新按钮功能
- 增强了向量服务不可用的错误处理机制
- 优化了搜索结果的阈值调节精度和范围
...
- [web/src/api/mcpClient.ts:1-183](file://web/src/api/mcpClient.ts#L1-L183)
...
- [web/src/api/mcpClient.ts:53-113](file://web/src/api/mcpClient.ts#L53-L113)
...
- [web/src/api/mcpClient.ts:128-130](file://web/src/api/mcpClient.ts#L128-L130)
...
**已更新** 浏览页面现在包含刷新按钮功能，允许用户在导入完成后无需重启服务即可重新拉取最新的Scope和文档列表。
...
**图表来源**
- [web/src/pages/BrowsePage.tsx:86-414](file://web/src/pages/BrowsePage.tsx#L86-L414)
...
- [web/src/api/mcpClient.ts:146-152](file://web/src/api/mcpClient.ts#L146-L152)

**章节来源**
- [web/src/pages/BrowsePage.tsx:1-414](file://web/src/pages/BrowsePage.tsx#L1-L414)
...
**已更新** 搜索页面的阈值控制得到了显著改进：
- 滑块最大值从1.0调整为0.2，更符合实际检索分数量级（~0.0x）
- 步长从0.05细化到0.005，提供更精确的阈值调节
- 新增±按钮支持，方便微调阈值设置
- 阈值显示精度提升到小数点后三位
...
**图表来源**
- [web/src/pages/SearchPage.tsx:26-284](file://web/src/pages/SearchPage.tsx#L26-L284)
- [web/src/api/mcpClient.ts:132-144](file://web/src/api/mcpClient.ts#L132-L144)

**章节来源**
- [web/src/pages/SearchPage.tsx:1-284](file://web/src/pages/SearchPage.tsx#L1-L284)
...
- [web/src/api/mcpClient.ts:166-182](file://web/src/api/mcpClient.ts#L166-L182)
...
- 搜索失败：
  - **已增强** 当后端返回ok=false时，显示error字段；现在提供更好的错误消息，包括向量库锁定或服务不可用的具体情况。
- 标签问题：
...
- [web/src/api/mcpClient.ts:76-113](file://web/src/api/mcpClient.ts#L76-L113)
- [web/src/pages/ImportPage.tsx:91-116](file://web/src/pages/ImportPage.tsx#L91-L116)
- [web/src/pages/SearchPage.tsx:78-92](file://web/src/pages/SearchPage.tsx#L78-L92)
- [web/src/api/httpApi.ts:184-189](file://web/src/api/httpApi.ts#L184-L189)

## 结论
该Web前端以清晰的模块化设计实现了知识库的总览、浏览、语义搜索、导入与写入能力。通过HTTP API与MCP工具的双通道集成，兼顾了结构化数据与检索能力。借助TanStack Query与合理的缓存策略，保证了良好的用户体验与性能。最近的更新进一步改善了搜索体验，提供了更精确的阈值控制和更好的错误处理机制。后续可按本文档的扩展指南新增页面、复用hooks与组件、对接新MCP工具或HTTP接口，实现功能持续演进。
...
- [web/src/api/mcpClient.ts:128-182](file://web/src/api/mcpClient.ts#L128-L182)
...
- [web/src/api/httpApi.ts:95-189](file://web/src/api/httpApi.ts#L95-L189)
- [web/src/api/mcpClient.ts:83-113](file://web/src/api/mcpClient.ts#L83-L113)
